    ...
    <div className={`sidebar ${sidebar ? "" : "small-sidebar"}`}>
      ...
      <div className="subscribe-list">
        ...
        <div className="side-link">
          <img src={jack} alt="PewDiepie Profile" />
          <p>PewDiepie</p>
        </div>
        <div className="side-link">
          <img src={simon} alt="MrBeast Profile" />
          <p>MrBeast</p>
        </div>
        <div className="side-link">
          <img src={tom} alt="Justin Bieber Profile" />
          <p>Justin Bieber</p>
        </div>
        <div className="side-link">
          <img src={megan} alt="5-Minute Crafts Profile" />
          <p>5-Minute Crafts</p>
        </div>
        <div className="side-link">
          <img src={cameron} alt="Nas Daily Profile" />
          <p>Nas Daily</p>
        </div>
      </div>
    </div>
